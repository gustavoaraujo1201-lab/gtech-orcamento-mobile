...
export function AppNavigator() { return <Stack.Navigator screenOptions={{ headerTintColor: colors.primary, headerTitleStyle: { fontWeight: '700' } }}><Stack.Screen name="Tabs" component={Tabs} options={{ headerShown: false }} /><Stack.Screen name="Editor" component={EditorOrcamentoScreen} options={{ title: 'Orçamento' }} /><Stack.Screen name="Detalhe" component={DetalheOrcamentoScreen} options={{ title: 'Detalhes do orçamento' }} /></Stack.Navigator>; }
