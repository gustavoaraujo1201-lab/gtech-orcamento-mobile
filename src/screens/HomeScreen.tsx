...
const styles = StyleSheet.create({ page: { flex: 1, backgroundColor: colors.background }, content: { padding: spacing.md, gap: spacing.md }, center: { flex: 1, alignItems: 'center', justifyContent: 'center' }, title: { color: colors.text, fontSize: 20, fontWeight: '600', marginVertical: spacing.lg }, metrics: { flexDirection: 'row', gap: spacing.sm, marginTop: spacing.md }, metric: { flex: 1 }, metricValue: { color: colors.primary, fontSize: 20, fontWeight: '800' }, muted: { color: colors.muted, marginTop: 3 }, section: { color: colors.text, fontSize: 17, fontWeight: '800', marginTop: spacing.sm }, row: { flexDirection: 'row', justifyContent: 'space-between' }, number: { fontSize: 12, color: colors.primary, fontWeight: '700' }, client: { fontSize: 16, color: colors.text, fontWeight: '700', marginTop: 4 }, right: { alignItems: 'flex-end', justifyContent: 'space-between' }, value: { color: colors.text, fontWeight: '800', marginTop: 10 }, empty: { color: colors.muted, textAlign: 'center', lineHeight: 21 } });
